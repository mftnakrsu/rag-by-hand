# Part 19 — Building a RAG Agent

> A reason/act/observe (ReAct) loop that reads its own transcript, picks one of four tools each step, and decides its route at run time — not author time. The agent the series kept describing, finally built by hand.

[📖 Read the essay](https://www.mefby.com/essays/rag-agent) · [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mftnakrsu/rag-by-hand/blob/main/part-19-rag-agent/rag_agent.ipynb)
...
python3 part-19-rag-agent/rag_agent.py             # runs offline
...
---
← [Part 18 — Structured and SQL RAG](../part-18-structured-sql-rag/) · [Series index](../) · [Part 20 — Conversational RAG →](../part-20-conversational-rag/)

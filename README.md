...
[mefby.com](https://www.mefby.com/essays): a 20-part arc, a 12-part core plus a 2026 **Frontier Track**.
...
advanced patterns, evaluation, and production hardening. Parts 13–20 are a 2026
...
complexity, then RAG vs long-context vs CAG, securing RAG, structured/SQL RAG,
...
| 10 | Advanced RAG Architectures | [corrective_rag.py](part-10-advanced-architectures/corrective_rag.py) · [agentic_loop.py](part-10-advanced-architectures/agentic_loop.py) | [corrective_rag.ipynb](part-10-advanced-architectures/corrective_rag.ipynb) | [read](https://www.mefby.com/essays/advanced-rag-architectures) |
...
| 20 | Conversational RAG | [conversational_rag.py](part-20-conversational-rag/conversational_rag.py) | [conversational_rag.ipynb](part-20-conversational-rag/conversational_rag.ipynb) | [read](https://www.mefby.com/essays/conversational-rag) |
